...
var PolicyMembersModalComponent = (function () {
    function PolicyMembersModalComponent(dialog, policyMembersService) {
        this.dialog = dialog;
    ...
    PolicyMembersModalComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PolicyMembersModalComponent.prototype.next = function (tabID) {
    };
    PolicyMembersModalComponent.prototype.beforeDismiss = function () {
        return true;
    };
    PolicyMembersModalComponent.prototype.beforeClose = function () {
        return null;
    };
    PolicyMembersModalComponent.prototype.close = function () {
        this.dialog.close();
    };
    PolicyMembersModalComponent.prototype.closeEvent = function (msg) {
        this.dialog.close();
    };
    PolicyMembersModalComponent.prototype.addPolicyMembers = function () {
        var _this = this;
    ...
    PolicyMembersModalComponent.prototype.removePolicyMembers = function (policyMembers) {
        var _this = this;
    ...
    PolicyMembersModalComponent.prototype.montaPolicyMembers = function () {
    ...
    return PolicyMembersModalComponent;
}());
PolicyMembersModalComponent = __decorate([
    core_1.Component({
        selector: 'modal',
...
], PolicyMembersModalComponent);
exports.PolicyMembersModalComponent = PolicyMembersModalComponent;
//# sourceMappingURL=policies.modal.component.js.map